document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- البيانات الأساسية للآلات الحاسبة ---
    const standardParts = [
        ...
        const headerHTML = `
            <div class="container">
                ...
                <div class="controls-container">
                    ...
                    <button id="theme-toggle" class="control-btn" title="Toggle dark/light mode"><i class="fas fa-moon"></i></button>
        ...
        const footerHTML = `
            <div class="container">
                <div class="footer-content">
                    <div class="footer-about"><h3 class="logo" data-i18n="companyName">[اسم المحل]</h3><p data-i18n="partnerText"></p></div>
                    <div class="footer-links"><h3 data-i18n="navLinks"></h3><ul><li><a href="products.html" data-i18n="navProducts"></a></li><li><a href="projects.html" data-i18n="navProjects"></a></li><li><a href="contact.html" data-i18n="navContact"></a></li></ul></div>
                </div>
                <div class="footer-bottom"><p>&copy; 2024 <span data-i18n="companyName">[اسم المحل]</span>. <span data-i18n="footerRights"></span></p></div>
            </div>`;
    ...
    function initializePageSpecificScripts() {
        ...
        if (plasmaForm) {
            ...
            plasmaForm.addEventListener('submit', (e) => {
                ...
                const remainingArea = (chosenPart.width * chosenPart.length) - (pieceWidth * pieceLength);
                const remainingDim1 = chosenPart.width - pieceWidth;
                const remainingDim2 = chosenPart.length - pieceLength;

                resultsOutput.innerHTML = `
                    <div class="result-breakdown">
                        <div class="cost-item"><span>${translations.materialCost || 'تكلفة المادة:'}</span><span>${materialCost.toLocaleString('fr-FR')} د.ج</span></div>
                        <div class="cost-item"><span>${translations.serviceCost || 'تكلفة خدمة القص:'}</span><span>${serviceCost.toLocaleString('fr-FR')} د.ج</span></div>
                        <hr>
                        <div class="cost-total"><span>${translations.totalCost || 'التكلفة الإجمالية:'}</span><span class="price">${totalCost.toLocaleString('fr-FR')} د.ج</span></div>
                    </div>
